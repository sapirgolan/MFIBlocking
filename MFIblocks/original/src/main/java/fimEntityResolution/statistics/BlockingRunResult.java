...
public class BlockingRunResult {
    ...
    public BlockingRunResult(BlockingResultContext resultContext) {
        ...
        this.recall = resultContext.getStatisticMeasurements().getRecall();
        this.precision = resultContext.getStatisticMeasurements().getPrecision();
        this.f_measure = resultContext.getStatisticMeasurements().getFMeasure();
        this.duplicatesFound = resultContext.getStatisticMeasurements().getDuplicatesFound();
        this.reductionRatio = resultContext.getStatisticMeasurements().getReductionRatio();
        this.totalDuplicates = resultContext.getStatisticMeasurements().getTotalDuplicates();
        this.comparisonsMade = resultContext.getStatisticMeasurements().getComparisonsMade();
